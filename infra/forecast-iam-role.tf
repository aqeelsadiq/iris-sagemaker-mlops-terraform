...
module "forecast_sagemaker_user_role" {
  source  = "terraform-aws-modules/iam/aws//modules/iam-role"
  version = "6.4.0"

  name        = lower(replace(local.placeholder, "%name%", "forecast-sagemaker-user"))
  path        = "/"
  description = "Role for Forecast Sagemaker Domain User"
