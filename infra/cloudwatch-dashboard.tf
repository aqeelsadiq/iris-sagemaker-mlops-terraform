    ...
    #   },
      ...
      },
      {
        ...
        properties = {
          ...
          metrics = [
            [{ "expression" : "SEARCH('{/aws/sagemaker/TrainingJobs,TrainingJobName} MetricName=\"train:accuracy\" \"IrisTraining\"', 'Average', 60)", "id" : "e1", "label" : "Accuracy" }],
            [{ "expression" : "SEARCH('{/aws/sagemaker/TrainingJobs,TrainingJobName} MetricName=\"train:f1_macro\" \"IrisTraining\"', 'Average', 60)", "id" : "e2", "label" : "F1 Macro" }]
          ]
        }
      },
      {
